...
import { LogsRepositoryController } from "../../../../../src/interfaces/controllers/aplications/logsRepository";
...
const sut = new LogsRepositoryController(systemProccessControlsStub);
...
describe("Std out Logs", () => {
    ...
    it("Should return error 404 if file not found", async () => {
